...
class LoginFrame(SF):
 ...
 def _do_login(self):
  ...
  if application.mobile_api.login(self.uid.GetValue(), self.pwd.GetValue(), application.app_id) and application.web_api.login(self.uid.GetValue(), self.pwd.GetValue()):
